 ...
 * using the NearestNeighborsKD instead of NearestNeighbors
...
public class Exp3 {
     ...
     */
    public Exp3(List<Point3D> points){
        this.points = points;
    }
     ...
     * Using the new NearestNeighborsKD class
    ...
    public void findClusters(){
        ...
        NearestNeighborsKD neighborsFinder = new NearestNeighborsKD(points);//helps find the neighbors of the points
    ...
    public static void main(String[] args) {
        ...
        Exp3 scan = new Exp3(Exp3.read(filename));
        ...
        System.out.println("the time taken using the new DBScan method is:"+ duration+ " ms");
